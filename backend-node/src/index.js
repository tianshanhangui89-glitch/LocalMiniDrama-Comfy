...
const freeCreateRoutes = require('./freeCreate');
...
function setupRouter(cfg, db, log) {
  ...
  const freeCreate = freeCreateRoutes(db, cfg, log);
  ...
  r.get('/free/creations', freeCreate.list);
  r.post('/free/text', freeCreate.createText);
  r.post('/free/audio', freeCreate.createAudio);
